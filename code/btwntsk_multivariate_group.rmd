---
title: "Trial-level analyses: multivariate projections --- between-tasks (leave-one-task-out)"
output:
  html_document:
    toc: true
    toc_depth: 3
...
fnames <- c(
  "network_hilo" = here("out", "icc", "projs-trials_axis-hilo_cval-btwntsk_schaefer-network07_prew-none_stand-axes_center-pattern_resid-errts.RDS"),
  "parcel_hilo"  = here("out", "icc", "projs-trials_axis-hilo_cval-btwntsk_schaefer-parcel_prew-none_stand-axes_center-pattern_resid-errts.RDS"),
  "network_ons" = here("out", "icc", "projs-trials_axis-ons_cval-btwntsk_schaefer-network07_prew-none_stand-axes_center-none_resid-errts.RDS"),
  "parcel_ons"  = here("out", "icc", "projs-trials_axis-ons_cval-btwntsk_schaefer-parcel_prew-none_stand-axes_center-none_resid-errts.RDS")
)
