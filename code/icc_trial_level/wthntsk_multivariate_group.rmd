...
fnames <- c(
  "network_hilo" = here("out", "icc", "projs-trials_axis-hilo_cval-wthntsk_schaefer-network07_prew-none_stand-axes_center-pattern_resid-errts.RDS"),
  "network_hilo_prw" = here("out", "icc", "projs-trials_axis-hilo_cval-wthntsk_schaefer-network07_prew-concat-runs-multi-alltask_stand-axes_center-pattern_resid-errts.RDS"),
  "parcel_hilo"  = here("out", "icc", "projs-trials_axis-hilo_cval-wthntsk_schaefer-parcel_prew-none_stand-axes_center-pattern_resid-errts.RDS"),
  "network_ons" = here("out", "icc", "projs-trials_axis-ons_cval-wthntsk_schaefer-network07_prew-none_stand-axes_center-none_resid-errts.RDS"),
  "network_ons_prw" = here("out", "icc", "projs-trials_axis-ons_cval-wthntsk_schaefer-network07_prew-concat-runs-multi-alltask_stand-axes_center-none_resid-errts.RDS"),
  "parcel_ons"  = here("out", "icc", "projs-trials_axis-ons_cval-wthntsk_schaefer-parcel_prew-none_stand-axes_center-none_resid-errts.RDS")
)
